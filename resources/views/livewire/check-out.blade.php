    ...
    <main class="container mx-auto mt-8 px-4 sm:px-14">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-2xl font-bold text-blue-900">Daftar Tamu Disetujui</h2>
                        ...
                        <div id="guest-{{ $guestBook->id }}"
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-right">
                                    <div class="text-sm text-gray-500 mb-2">Check-in pada</div>
            ...
            @else
                <div class="flex flex-col items-center justify-center h-48 bg-gray-50 rounded-xl">
                    ...
                    <p class="text-gray-500 text-center font-medium">Tidak ada tamu yang belum checkout saat ini.</p>
                </div>
            @endif
        </div>
    </main>
